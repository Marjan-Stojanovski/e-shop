                ...
                <div class="col-lg-10 mx-auto">
                    <form class="needs-validation" novalidate="">
                        ...
                        <table class="table mb-5 table-bordered">
                            ...
                            <tr>
                                <td class="product-name">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <strong class="product-qty ms-3 text-muted">x 1</strong>
                                    </div>
                                </td>
                                <td>$36.00</td>
                            </tr>
                            <tr>
                                <td class="product-name">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <strong class="product-qty ms-3 text-muted">x 2</strong>
                                    </div>
                                </td>
                                <td>$118.00</td>
                            </tr>
                            ...
                            <tr>
                                <th>Order Total</th>
                                <td class="fw-bold fs-5 text-dark"><strong>$154.00</strong></td>
                            </tr>
                            </tfoot>
                        </table>
                        ...
                        <div class="mb-3" id="payment_methods">
                            <div class="position-relative border border-secondary overflow-hidden mb-2">
                                ...
                                <div class="collapse show" id="mothod_payment_card"
                            ...
                            <div class="position-relative border border-secondary overflow-hidden">
                                ...
                                <div class="collapse" id="mothod_payment_paypal"
                                    ...
                                    <div class="px-3 py-4">
                                        ...
                                        <a href="#" class="btn btn-info">Pay with Paypal</a>
                                    </div>
                                </div>
                            </div>
                        </div>

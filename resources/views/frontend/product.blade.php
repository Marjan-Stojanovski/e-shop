                        ...
                        <div class="mb-0">
                            ...
                            <div class="d-md-flex align-items-center justify-content-between">
                                <div class="d-flex" role="group" aria-label="Basic checkbox toggle button group">
                                    ...
                                    <label class="btn btn-sm lh-1 btn-outline-secondary py-1 flex-center me-2 px-2"
                                    ...
                                    <label class="btn btn-sm btn-outline-secondary flex-center me-2 px-2" for="radioSizeXL">XL</label>

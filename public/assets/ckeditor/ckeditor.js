...
(function () {
    ...
    CKEDITOR.env || (CKEDITOR.env = function () {
        var a = navigator.userAgent.toLowerCase(), d = a.match(/edge[ \/](\d+.?\d*)/), b = a.indexOf("trident/") > -1,
            b = !(!d && !b), b = {
                ie: b,
                edge: !!d,
    ...
    (function () {
        var a = [], d = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "",
            ...
            i = {lt: "<", gt: ">", amp: "&", quot: '"', nbsp: " ", shy: "­"}, j = function (a, g) {
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, d = function (a, b) {
                ...
                table: 1,
                ul: 1
            }, f = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, h = {}, i = {"#": 1},
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype,
            {
                ...
                show: function () {
                    ...
                    if (document.documentElement.getBoundingClientRect) {
                        var e = this.$.getBoundingClientRect(), o = g.$.documentElement,
                            p = o.clientTop || d.$.clientTop || 0, f = o.clientLeft || d.$.clientLeft || 0, h = true;
                        if (CKEDITOR.env.ie) {
    ...
    (function () {
        function a(a, b) {
            ...
            g = c.endContainer;
            var e = c.startOffset, f = c.endOffset, h, i = this.guard, l = this.type,
            ...
            if (a && !this._.guardRTL) {
                var F = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(),
                    w = d.type == CKEDITOR.NODE_ELEMENT ? e ? d.getChild(e - 1) : null : d.getPrevious();
        ...
        var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, f = CKEDITOR.dom.walker.whitespaces(),
            h = CKEDITOR.dom.walker.bookmark(), i = CKEDITOR.dom.walker.temp();
    ...
    (function () {
        ...
        CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                if (!this.collapsed) {
                    var a =
                            a || CKEDITOR.SHRINK_TEXT, d = this.clone(), e = this.startContainer, f = this.endContainer,
                        h = this.startOffset, i = this.endOffset, j = 1, n = 1;
    ...
    (function () {
        ...
        function b(a, c, e, f) {
            ...
            if ((h = CKEDITOR.filter.instances[f.element.data("cke-filter")]) &&
                !h.check(c)) return b(a, c, e, f.remaining);
    ...
    (function () {
        ...
        var H = CKEDITOR.dtd, A = 1, K = CKEDITOR.tools.copy, E = CKEDITOR.tools.trim, r = "cke-test",
            J = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var k = this, e = [], m = this.editor && this.editor.config.protectedSource, f, g = false,
                    v = {doFilter: !c, doTransform: true, doCallbacks: true, toHtml: b};
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
        ...
        var D = {styles: 1, attributes: 1, classes: 1},
            y = {styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses"},
            v = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i,
            L = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, O = /^cke:(object|embed|param)$/,
            aa = /^(object|embed|param)$/, U = CKEDITOR.filter.transformationsTools = {
    ...
    (function () {
        CKEDITOR.lang = {
            languages: {
                ...
                var b = this.languages, d = d || navigator.userLanguage || navigator.language || a,
                    c = d.toLowerCase().match(/([a-z]+)(?:-([a-z]+))?/), e = c[1], c = c[2];
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function (f, h, i) {
                ...
                var o = new CKEDITOR.htmlParser,
                    ...
                    t = [], x = [], u = p, C = p.name == "textarea", l = p.name == "pre";
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    f = Array.prototype.slice.call(arguments, 1), h = this.rules, i = h.length, j, n, g, B;
                for (B = 0; B < i; B++) {
                    if (d) {
                        j = c.type;
                        n = c.name
    ...
    (function () {
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                var a = a.data, c = a.dataValue, k, c = p(c, b), c = g(c, E), c = n(c), c = g(c, K),
                    c = c.replace(J, "$1cke:$2"), c = c.replace(y, "<cke:$1$2></cke:$1>"),
                    c = c.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"),
        ...
        var t = /(?:&nbsp;|\xa0)$/, x = "{cke_protected}", u = CKEDITOR.dtd,
            C = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"],
            l = CKEDITOR.tools.extend({}, u.$blockLimit, u.$block), q = {elements: {input: i, textarea: i}},
        ...
        var w = /<(a|area|img|input|source)\b([^>]*)>/gi,
            H = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, A = /^(href|src|name)$/i,
            K = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
            E = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi,
            r = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
            J = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi,
            D = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, y = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })();
    "use strict";
    ...
    (function () {
                ...
                getData: function (a) {
                    ...
                    if (!this.is("textarea")) {
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in e) {
                                var b = a.getSelection(), g, f = b.getRanges()[0], h = f.startPath(), m, l, w,
                                    c = c == 8;
        ...
        var o = CKEDITOR.dom.walker.whitespaces(true), p = CKEDITOR.dom.walker.bookmark(false, true),
            t = CKEDITOR.dom.walker.empty(), x = CKEDITOR.dom.walker.bogus(),
            ...
            C = function () {
                ...
                function c(b,
                           d) {
                    var e = [], g = b.getChildren(), f = g.count(), r, l = 0, m = h[d],
                        w = !b.is(h.$inline) || b.is("br");
                    for (w && e.push(" "); l < f; l++) {
                        r = g.getItem(l);
                ...
                return function (l, y, v, q) {
                    ...
                    if (!q.checkReadOnly()) {
                        ...
                        if (s = v) {
                            ...
                            if (/^\s+|\s+$/.test(v) && "span" in CKEDITOR.dtd[p]) var u = '<span data-cke-marker="1">&nbsp;</span>',
                                v = u + v + u;
                            ...
                            if ((u = s.startPath().block) &&
                                !(u.getChildCount() == 1 && u.getBogus())) a:{
                                var t;
                        ...
                        if (s) {
                            ...
                            var G;
                            p = l.blockLimit;
                            var q = 0, I, u = [], x, C, v = n = 0, N, V, y = t.startContainer,
                                o = l.endPath.elements[0], W, E = o.getPosition(y),
                                z = !!o.getCommonAncestor(y) && E != CKEDITOR.POSITION_IDENTICAL && !(E & CKEDITOR.POSITION_CONTAINS +
            ...
            return {
                list: {
                    detectMerge: function (a, b) {
                        var d = c(b,
                                a.bookmark), e = d.startPath(), g = d.endPath(), f = e.contains(CKEDITOR.dtd.$list),
                    ...
                    function a(c) {
                        var e = [], g, f = new CKEDITOR.dom.walker(c), h = c.startPath().contains(d),
                            k = c.endPath().contains(d), l = {};
                        f.guard = function (a,
                                            f) {
                            if (a.type == CKEDITOR.NODE_ELEMENT) {
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            e.on("contentDom", function () {
                ...
                var g = e.document, f = CKEDITOR.document, l = e.editable(), i = g.getBody(),
                    j = g.getDocumentElement(), r = l.isInline(), q, D;
                    ...
                    var a = x ? function () {
                        ...
                        var b = function (b, c) {
                            ...
                            for (var e = d.children, g, f, h = b.duplicate(), r = 0, l = e.length - 1, k = -1, i, j; r <= l;) {
                                ...
                                if (i > 0) l = k - 1; else if (i < 0) r = k + 1; else return {
                                    container: d,
                                    offset: a(g)
                                }
                            }
    ...
    (function () {
            ...
            if (b.collapsed) {
                ...
                for (m.getPosition(o) == CKEDITOR.POSITION_FOLLOWING && (m = 0); m;) {
                    ...
                    if (m.equals(o)) {
                        ...
                        var q = m.type == CKEDITOR.NODE_ELEMENT ? m.getName() : null,
                            p = q && m.getAttribute("contentEditable") == "false",
                            u = q && m.getAttribute("data-nostyle");
        ...
        function s(a, b) {
            var c = this._.definition,
                d = c.attributes, c = c.styles, e = C(this)[a.getName()],
        ...
        var k = {
            ...
            }, m =
                {
                    ...
                    audio: 1,
                    video: 1
                }, F = /\s*(?:;\s*|$)/, w = /#\((.+?)\)/g, H = CKEDITOR.dom.walker.bookmark(0, 1),
    ...
    (function () {
        function a(a, c, d) {
            var f = a.serializable, h = c[d ? "endContainer" : "startContainer"], i = d ? "endOffset" : "startOffset",
...
*/
            ...
            CKEDITOR.ui.dialog.file.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, n, {
                getInputElement: function () {
                    ...
                    var a = this._, d = CKEDITOR.document.getById(a.frameId).getFrameDocument(), f = a.definition,
                        ...
                        g = a.dialog._.editor.lang.dir, i = a.dialog._.editor.langCode;
    ...
    (function () {
        ...
        function U(a) {
            function b(b) {
                var c = a.getSize(), i = CKEDITOR.document.getWindow().getViewPaneSize(), o = b.data.$.screenX,
                    j = b.data.$.screenY, n = o - e.x, k = j - e.y;
                e = {x: o, y: j};
                d.x += n;
                d.y += k;
        ...
        CKEDITOR.dialog = function (a, b) {
            ...
            var f = CKEDITOR.dialog._.dialogDefinitions[b], h = CKEDITOR.tools.clone(W),
                m = a.config.dialog_buttonsOrder || "OS", l = a.lang.dir, i = {}, o, j;
        ...
        (function () {
            CKEDITOR.ui.dialog = {
                uiElement: function (a,
                                     b, c, e, d, g, f) {
                    if (!(4 > arguments.length)) {
                        var h = (e.call ? e(b) : e) || "div", m = ["<", h, " "], l = (d && d.call ? d(b) : d) || {},
    ...
    (function () {
        ...
        function v(b) {
            ...
            function l(a) {
                var d = {type: "auto", method: "paste", dataTransfer: o.initPasteDataTransfer(a)},
                    c = !CKEDITOR.env.ie && !CKEDITOR.env.safari,
                    e = d.dataTransfer.getTransferType(b) === CKEDITOR.DATA_TRANSFER_EXTERNAL;
        ...
        function A(b) {
            ...
            b.on("contentDom", function () {
                ...
                var h = b.editable(), i = CKEDITOR.plugins.clipboard.getDropTarget(b), s = b.ui.space("top"),
                    t = b.ui.space("bottom");
                s && s.on("dragover", c);
                t && t.on("dragover", c);
        ...
        CKEDITOR.plugins.add("clipboard", {
            requires: "dialog", init: function (b) {
                ...
                b.on("paste", function (a) {
                    var a = a.data, e = a.type, f = a.dataValue, g, h = b.config.clipboard_defaultContentType || "html",
        ...
        CKEDITOR.plugins.clipboard = {
            ...
            getRangeAtDropPosition: function (b, a) {
                var c = b.data.$, d = c.clientX, e = c.clientY, f = a.getSelection(!0).getRanges()[0],
                    g = a.createRange();
                ...
                if (a = a || r(b)) {
                    ...
                    if (i && k) {
                        if (c && (c.is("li") || c.getParent().is("li"))) {
                            ...
                            a = c.getParent();
                            e = a.getParent();
                            var h = !c.hasPrevious(), m = !c.hasNext(), l = b.getSelection(), g = l.createBookmarks(),
                                i = c.getDirection(1), k = c.getAttribute("class"), o = c.getAttribute("style"),
                                n = e.getDirection(1) != i, b = b.enterMode != CKEDITOR.ENTER_BR || n || o || k;
        ...
        function i(a) {
            ...
            if (m) {
                var i = new CKEDITOR.template('<div id="cke_{name}" class="cke {id} cke_reset_all cke_chrome cke_editor_{name} cke_float cke_{langDir} ' + CKEDITOR.env.cssClass + '" dir="{langDir}" title="' + (CKEDITOR.env.gecko ?
                        " " : "") + '" lang="{langCode}" role="application" style="{style}"' + (a.title ? ' aria-labelledby="cke_{name}_arialbl"' : " ") + ">" + (a.title ? '<span id="cke_{name}_arialbl" class="cke_voice_label">{voiceLabel}</span>' : " ") + '<div class="cke_inner"><div id="{topId}" class="cke_top" role="presentation">{content}</div></div></div>'),
    ...
    (function () {
        ...
        var h = CKEDITOR.dtd.$listItem, m = CKEDITOR.dtd.$list, i = CKEDITOR.TRISTATE_DISABLED,
            ...
            listToArray: function (b,
                ...
                for (var g, i = b[e].parent.getDocument(), h = new CKEDITOR.dom.documentFragment(i), d = null, a = e, m = Math.max(b[e].indent, 0), j = null, n, l, p = c == CKEDITOR.ENTER_P ? "p" : "div"; ;) {
                    ...
                    if (o.indent == m) {
                        ...
                        var d = g.getDirection(1) != n, u = o.element, z = u.getAttribute("class"),
                            v = u.getAttribute("style"),
                            w = j.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && (c != CKEDITOR.ENTER_BR || d || v || z), s,
    ...
    (function () {
        ...
        function ga(a) {
            var c = a.doc,
                ...
                b = CKEDITOR.getUrl(this.path + "images/" + (o.hidpi ? "hidpi/" : "") + "icon" + (a.rtl ?
                    "-rtl" : "") + ".png");
            q(d, {
                attach: function () {
            ...
            return {
                canUndo: !0, modes: {wysiwyg: 1}, exec: function () {
                    ...
                    return function (b) {
                        ...
                        if (!V(a, b) && b && !b.equals(a.editable) &&
        ...
        var q = CKEDITOR.tools.extend, M = CKEDITOR.dom.element, B = M.createFromHtml, o = CKEDITOR.env,
            da = CKEDITOR.env.ie && 9 > CKEDITOR.env.version, w = CKEDITOR.dtd, F = {}, D = 128, Y = 64, O = 32, H = 16,
            ea = 8, x = 4, y = 2, s = 1, E = " ", $ = w.$listItem, ja = w.$tableContent,
            ha = q({}, w.$nonEditable, w.$empty), U = w.$block, aa = 100,
    ...
    CKEDITOR.plugins.add("scayt", {
        requires: "menubutton,dialog", tabToOpen: null, dialogName: "scaytDialog", init: function (a) {
            ...
            var c = a.dataProcessor, d = c && c.htmlFilter, b = a._.elementsPath && a._.elementsPath.filters,
                c = c && c.dataFilter, f = a.addRemoveFormatFilter, e = function (d) {
        ...
        if (!0 === CKEDITOR.config.scayt_handleCheckDirty) {
            ...
            a.checkDirty = CKEDITOR.tools.override(a.checkDirty, function (a) {
                return function () {
                    ...
                    if (!CKEDITOR.plugins.scayt || !CKEDITOR.plugins.scayt.state[this.name] || !this.scayt) b = a.call(this); else if (b = "ready" == this.status) var e = c.removeMarkupFromString(this.getSnapshot()),

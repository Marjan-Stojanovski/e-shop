...
( function() {
	...
	Liner.prototype = {
		...
		getStyle: function( uid, type ) {
			...
			// Collection should be between two elements.
			if ( rel.siblingRect ) {
				styles.width = Math.max( rel.siblingRect.width, rel.elementRect.width );
			}
			// Collection is relative to a single element.
			else {
	...
	/**
	 * Global namespace storing definitions and global helpers for the Collection Utilities plugin.
	 *
	 * @private
	 * @class
	 * @singleton
